...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0x444d82af0b7C7880B98004379787Deb440c58168;
...
contract CryoWebToken is Context, IERC20, Ownable {
    ...
    string private _name = "CryoWeb Token";
    ...
    address developerAddress=0x61bAA0e6002e8Eb0dd8A46939b0A55b515E59C94;// developer address address
     
    uint256 public _feeDecimal = 0; // do not change this value...
    uint256 public _taxFee = 5; // means 5%(distributed to all holders)
    uint256 public _liquidityFee = 3; // means 3%
    uint256 public _burnFee = 0; // means 0% no burnFee is included in your code
    uint256 public developerFee=200; // 200 means 2% this is how it sets (this is the Developer fee)
    ...
    constructor() public {
        ...
        emit Transfer(address(0),owner(), _reflectionBalance[owner()]);
    }
    ...
    uint256 roundValue = value.ceil(developerFee);
    uint256 onePercent = roundValue.mul(developerFee).div(10000);
    return onePercent;
  }
    ...
    function _transfer(
        ...
        //Owner fee
        _reflectionBalance[developerAddress] = _reflectionBalance[developerAddress].add(tokensToBurn.mul(rate));
    ...
    function setDeveloperFee(uint256 amount) external onlyOwner {
        developerFee= amount;
    }
